...
<div class="container" style="margin-top: 30px;margin-bottom: 60px">
    <div class="row a">
        ...
        <div class="col-md-2 divcouleur2" style="margin-bottom: 10px">
            <img src="{{asset('assets/assets/images/ceramic/format.png')}}" class="iconecouleur" style="">
            <span class="name-opt"> Produits de cette série</span>
        </div>
        <div class="col-md-10">
            <div class="container">
    
    <div class="row">
        <div style="color:rgb(225,15,26);font-size: 22px;margin-bottom: 10px;margin-left: 30px" class="divcouleur1 name-opt">Produits de cette série</div>
        <div style="border-top: 2px solid rgb(225,15,26);width: 200px"></div>
         <div class="bord">
                      ...
                      @isset($details_product)
                        @foreach($details_product as $detail)
                                <div class="item" style="width: 190px">
                                    <div class="pad15">
                                        <div class="pad15">
                                        <p class="lead" style="font-size: 18px;color:rgb(225,15,26)">{{$detail->title}}</p>
                                        <div class="carred aa carred{{$key}}" id="{{$option->id}}" >
                                        <img src="{{asset($detail->image)}}" style="height: 100%;width: 100%">
                                        </div>
                                        </div>
                                    </div>
                                </div>
