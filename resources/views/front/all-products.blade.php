    ...
    <div class='row'>
      <div class='col-xs-12 col-sm-12 col-md-3 sidebar'> 
        ...
        <div class="side-menu animate-dropdown outer-bottom-xs">
          <div class="head"><i class="icon fa fa-align-justify fa-fw"></i> {{__('site/all-products.categories')}}</div>
        ...
        <div class="sidebar-module-container">
          <div class="sidebar-filter"> 
            <div class="sidebar-widget">
              <h3 class="section-title">{{__('site/all-products.filterby')}}</h3>
              <div class="widget-header">
                <h4 class="widget-title">{{__('site/all-products.categories')}}</h4>
              </div>
              @foreach(AllCategorie() as $category)
            ...
            <div class="sidebar-widget">
              <div class="widget-header">
                <h4 class="widget-title">{{__('site/all-products.price')}}</h4>
              </div>
              <div class="sidebar-widget-body m-t-10">
                ...
                <!-- /.price-range-holder --> 
                <button class="lnk btn btn-primary">{{__('site/all-products.filter')}}</button> 
            ...
            <div class="sidebar-widget">
              <div class="widget-header">
                <h4 class="widget-title">{{__('site/all-products.brand')}}</h4>
              </div>
              <div class="sidebar-widget-body">
                    @isset($brands)
            ...
            <div class="sidebar-widget product-tag outer-top-vs">
              <h3 class="section-title">{{__('site/all-products.productstags')}}</h3>
          ...
          <div class="item">
            ...
            <div class="container-fluid">
              <div class="caption vertical-top text-left">
                <div class="big-text"> {{__('site/all-products.ourproducts')}} </div>
                <div class="excerpt hidden-sm hidden-md"> {{__('site/all-products.welcome')}}  </div>
                <div class="excerpt-normal hidden-sm hidden-md">{{__('site/all-products.trouverourproducts')}}</div>
              </div>
              <!-- /.caption --> 
            </div>
            <!-- /.container-fluid --> 
      ...
      @if($products->count()>0)
            ...
            <div class="col col-sm-6 col-md-3 col-lg-3 col-xs-6">
              <div class="filter-tabs">
                <ul id="filter-tabs" class="nav nav-tabs nav-tab-box nav-tab-fa-icon">
                  <li class="active"> <a data-toggle="tab" href="#grid-container"><i class="icon fa fa-th-large"></i>{{__('site/all-products.grid')}}</a> </li>
                  <li><a data-toggle="tab" href="#list-container"><i class="icon fa fa-bars"></i>{{__('site/all-products.liste')}}</a></li>
                </ul>
              </div>
              <!-- /.filter-tabs --> 
            </div>
                ...
                <div class="lbl-cnt"> <span class="lbl">Afficher par</span>
                  <div class="fld inline">
                    <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                      <button data-toggle="dropdown" type="button" class="btn dropdown-toggle"> {{__('site/all-products.position')}} <span class="caret"></span> </button>
                      <ul role="menu" class="dropdown-menu">
                        <li role="presentation"><a href="{{route('product.price.orderby','DESC')}}">{{__('site/all-products.price')}}:{{__('site/all-products.desc')}}</a></li>
                        <li role="presentation"><a href="{{route('product.price.orderby','ASC')}}">{{__('site/all-products.price')}}:{{__('site/all-products.asc')}}</a></li>
                        <li role="presentation"><a href="{{route('product.vente')}}">{{__('site/all-products.bestseller')}}</a></li>
                      </ul>
                    </div>
                  </div>
                  <!-- /.fld --> 
        ...
        @else
            <div class="alert alert-danger text-center">
              <p>{{__('site/all-products.noproduct')}}</p>
            </div>
        @endif
