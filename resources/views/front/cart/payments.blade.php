        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="{{ route('payment.process') }}" method="post" class="validation"
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 form-group card required'>
                                ...
                                <input
                                    autocomplete='off' class='form-control card-num' size='16'
                                    type='text'>
                            </div>
                        </div>
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 col-md-4 form-group cvc required'>
                                ...
                                <input autocomplete='off' class='form-control card-cvc' placeholder='e.g 415' size='3'
                                    type='text'>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-danger btn-lg btn-block" type="submit">Pay Now {{Cart::subtotal()}}</button>
                            </div>
                        </div>
