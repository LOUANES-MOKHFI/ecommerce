...
@section('title','Ajouter un sous categorie')
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href=""> {{__('admin/category.all_subcategory') }}  </a>
                                </li>
                                <li class="breadcrumb-item active">{{__('admin/category.addsubcategory') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">  {{__('admin/category.addsubcategory') }}  </h4>
