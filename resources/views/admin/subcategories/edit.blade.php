...
@section('title','Modifier un sous categorie')
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{__('admin/category.edit') }} - {{$subCategory -> name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                                                                    ...
                                                                    @if($categories && $categories->count()>0)
                                                                        @foreach($categories as $category)
                                                                            <option value="{{$category->id}}"
                                                                                @if($category->id == $subCategory->parent_id) selected  @endif>
                                                                                {{$category->name}}
