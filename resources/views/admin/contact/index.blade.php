        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">Tout les messages</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="">{{__('admin/header.home')}} </a>
                                </li>
                                <li class="breadcrumb-item active">Tout les messages
                                </li>
                            </ol>
                        </div>
                    </div>
                                            ...
                                            @isset($contact)
                                                @foreach($contact as $contact)
                                                    <tr>
                                                        ...
                                                        <td>{{$contact ->state->nom}}</td>
                                                        <td>{{$contac -> communes->nom}}</td>
                                                        <td>{{$category -> phone}}/{{$category -> fax}}</td>
