                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.sliders')}}"> Tout les video </a>
                                </li>
                                <li class="breadcrumb-item active">Ajouter une video
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">  Ajouter une video  </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.videos.store.db')}}"
                                              method="POST"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="video/*" value="{{old('title')}}" id="name"
                                                                           class="form-control"
                                                                           placeholder="  "
                                                                           name="title" >
                                                                    @error("title")
...
@section('script')
 ...
 <script>
            ...
            Dropzone.options.dpzMultipleFiles = {
                ...
                ,
                url: "{{ route('admin.videos.store') }}", // Set the url
                success:
