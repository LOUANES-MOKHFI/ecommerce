...
@section('title','Tout les slides')
@section('content')
    <div class="app-content content">
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">Tout les slides</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="">{{__('admin/header.home')}} </a>
                                </li>
                                <li class="breadcrumb-item active">Tout les slides
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h4 class="card-title">Tout les slides</h4>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <table
                                            ...
                                            @isset($sliders)
                                                @foreach($sliders as $slider)
                                                    <tr>
                                                        <td> <img style="width: 150px; height: 100px;" src="{{$slider->photo}}"></td>
                                                        <td>{{$slider -> title}}</td>
